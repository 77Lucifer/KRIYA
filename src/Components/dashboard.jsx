                ...
                <div className="creator-information">
                    <div className="creator-detail">
                        <table className="creator-table">
                            <thead>
                                <tr>
                                    <td colSpan="3" className="creator-info">
                                        <span>Profile</span>
                                        <span>Status</span>
                                        <span>Prices</span>
                                    </td>
                            ...
                            <tbody>
                                <tr>
                                    <td colSpan="3" className="creator-followers tbody-td">
                                        <span>Followers</span>
                                        <span>Actions</span>
                                        <span>Operation</span>
                                    </td>
