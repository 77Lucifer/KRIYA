    ...
    <>
      ...
      <div className="creator-main">
        ...
        <div className="creator-inner">
            <div className="input"><i class="fa-solid fa-user"></i><input placeholder='Search' type="search" /></div>
            <div className="creator-box">
              <div className="creator">
                ...
                <h3>Aubree Valentine</h3>
                <h5>Actor</h5>
              </div>
              <div className="creator">
                <img src="https://firebasestorage.googleapis.com/v0/b/creators-dev-prod.appspot.com/o/profile_images%2F2dce5e8b-da2e-4573-aa6c-274be2118108?alt=media&token=b2a699b8-5493-41d7-82ff-3517d699578d" alt="" />
                <h3>Connect and Collabs </h3>
                <h5>Influencer, Model</h5>
              </div>
              <div className="creator">
                <img src="https://firebasestorage.googleapis.com/v0/b/creators-dev-prod.appspot.com/o/profile_images%2F72ed31c2-a7bb-4ab0-a77b-b972591769c9?alt=media&token=d5e86b68-3d10-4765-871e-0c11fe361116" alt="" />
                <h3>Rion King</h3>
                <h5>Photographer</h5>
              </div>
            </div>
